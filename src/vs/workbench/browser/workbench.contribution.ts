	...
	registry.registerConfiguration({
		...
		'properties': {
			...
			[LayoutSettings.SECONDARY_SIDEBAR_ACTIVITY_BAR_LOCATION]: {
				'type': 'string',
				'enum': ['default', 'top', 'bottom', 'side', 'hidden'],
				'default': 'default',
				'markdownDescription': localize({ comment: ['This is the description for a setting'], key: 'secondarySideBarActivityBarLocation' }, "Controls the location of the Activity Bar in the Secondary Side Bar. By default, the Activity Bar is shown inline. Set to {0} to show a vertical Activity Bar.", '`side`'),
				'enumDescriptions': [
					...
					localize('workbench.secondarySideBar.activityBar.location.side', "Show a vertical Activity Bar on the side of the Secondary Side Bar."),
